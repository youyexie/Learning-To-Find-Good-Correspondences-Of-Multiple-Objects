...
img = imread('gmu_scene_001\Images\rgb_846.png');
depth = imread('gmu_scene_001\Depths\depth_846.png');
scale = 6.2385;
load('gmu-kitchens_info\scene_pose_info\scene_1_reconstruct_info_frame_sort.mat');
cam1 = frames(847)
...
%%%
save('FaceClassifier\InputData\\match15.mat','input')

%% load the inference result

result = readNPY('FaceClassifier\InferenceResult\match15.npy');


%% the inference result for objects

PostProcessingRT(point_3d,K,f1match,f2match,I1,I2,result,1)