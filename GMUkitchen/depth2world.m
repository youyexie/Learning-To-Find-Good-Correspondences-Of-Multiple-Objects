...
function [camera_pcl , w_pcl] = depth2world(depth, scale, cam1)
...
center = [9.5926120509632392e+02 5.2911546499433564e+02];
[imh, imw] = size(col_depth);
pcloud = zeros(imh,imw,3);
xgrid = ones(imh,1)*(1:imw) - center(1);
ygrid = (1:imh)'*ones(1,imw) - center(2);
pcloud(:,:,1) = -xgrid.*col_depth/1.0477637710998533e+03;
pcloud(:,:,2) = ygrid.*col_depth/1.0511749325842486e+03;
pcloud(:,:,3) = col_depth;
